...
lion_king = media.Movie(
    ...
    "24 June 1994",
    "https://images-na.ssl-images-amazon.com/images/M/MV5BYTYxNGMyZTYtMjE3MS00MzNjLWFjNmYtMDk3N2FmM2JiM2M1XkEyXkFqcGdeQXVyNjY5NDU4NzI@._V1_SY1000_CR0,0,673,1000_AL_.jpg",  # Noqa
...
lotr_fellowship = media.Movie(
    ...
    to destroy the powerful One Ring and save Middle Earth from the Dark Lord
    Sauron.""",
    media.Movie.VALID_RATINGS[2],
    "8.8",
    "2h 58min",
...
up = media.Movie(
    ...
    "29 May 2009",
    "https://images-na.ssl-images-amazon.com/images/M/MV5BMTk3NDE2NzI4NF5BMl5BanBnXkFtZTgwNzE1MzEyMTE@._V1_SY1000_CR0,0,664,1000_AL_.jpg",  # Noqa
